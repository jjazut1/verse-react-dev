...
async function runTest() {
    ...
    const isSetupSuccessful = (0, sendgridHelper_1.setupSendGrid)(apiKey);
    ...
    try {
        ...
        const simpleResult = await (0, sendgridHelper_1.sendEmail)(simpleEmail);
        console.log('Simple format test result:', simpleResult ? 'SUCCESS' : 'FAILED');
        console.log('\n--- Testing detailed email format ---');
        const detailedResult = await (0, sendgridHelper_1.sendEmail)(detailedEmail);
...
//# sourceMappingURL=testSendEmail.js.map