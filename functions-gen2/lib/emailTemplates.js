...
exports.getPersonalizedInstallInstructions = exports.createPWAPasswordSetupTemplate = exports.createAssignmentEmailTemplate = void 0;
/**
...
<body>
    <div class="container">
        ...
        <div class="assignment-info">
            ...
            ${(assignmentDetails === null || assignmentDetails === void 0 ? void 0 : assignmentDetails.gameType) ? `<p><strong>Game Type:</strong> ${assignmentDetails.gameType}</p>` : ''}
            ${(assignmentDetails === null || assignmentDetails === void 0 ? void 0 : assignmentDetails.timesRequired) ? `<p><strong>Required Completions:</strong> ${assignmentDetails.timesRequired} time${assignmentDetails.timesRequired > 1 ? 's' : ''}</p>` : ''}
        </div>
